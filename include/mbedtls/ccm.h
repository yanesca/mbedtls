 ...
 */
typedef int (*mbedtls_ccm_svar_enc_callback)( void *app_ctx, size_t tag_len,
                                              unsigned char *nonce,
                                              size_t nonce_len );
 ...
 * \return          MBEDTLS_ERR_CCM_BAD_INPUT error code on failure.
 */
typedef int (*mbedtls_ccm_svar_dec_callback)( void *app_ctx, size_t* tag_len,
...
int mbedtls_ccm_svar_encrypt_and_tag( mbedtls_ccm_context *ctx, size_t length,
                         ...
                         size_t tag_len, mbedtls_ccm_svar_enc_callback get_iv,
                         void *get_iv_ctx );
...
int mbedtls_ccm_svar_auth_decrypt( mbedtls_ccm_context *ctx, size_t length,
                      ...
                      const unsigned char *input, unsigned char *output,
                      size_t* output_len,
                      mbedtls_ccm_svar_dec_callback get_tag_len,
                      void *get_tlen_ctx );
